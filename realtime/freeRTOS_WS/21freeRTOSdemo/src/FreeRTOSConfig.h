...
//xx#define configCPU_CLOCK_HZ						100000000UL /*este es la frecuencia de OTRA placa*/
#define configCPU_CLOCK_HZ						650000000UL //xx /*este es la frecuencia de NUESTRA placa*/
#define configUSE_PORT_OPTIMISED_TASK_SELECTION	1
#define configUSE_TICKLESS_IDLE					0
#define configTICK_RATE_HZ						( ( TickType_t ) 1000 ) //1ms is the lowest time u can specify in FreeRTOS
//xx#define configPERIPHERAL_CLOCK_HZ  				( 33333000UL )
